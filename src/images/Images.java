...
{    
    public static final ImageIcon imagenJugador=new ImageIcon("src/images/Jugador.jpg");
    public static final ImageIcon imagenOponente=new ImageIcon("src/images/Oponente.jpg");
    public static final ImageIcon imagenMuro=new ImageIcon("src/images/bomberman_pared.png");
